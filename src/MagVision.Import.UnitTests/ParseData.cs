...
namespace MagVision.Import.UnitTests
{
    ...
    public class ParsePatient
    {
        ...
        {
            data = new string[] { "0", "Mustermann", "Max", "Musterstraße 12", "9999", "Musterstadt", "0666 999 999 999", "17.05.1938", "1234", "1", "2", "0", "2", "1234", "Frau Mustermann", "31 05 90", "Entenhausen.12 4444 Europe", "0", "0", "0", "0", "1", "0", "1", "0", "1", "0", "0" };
            data2 = new string[] { "Dr.", "Quak", "Alfred J.", "0", "0", "0", "0", "13 08 1938", "0", "2", "1", "0", "3", "12345", "0", "0", "0", "0666 999 888 777", "Mutter", "01 01 2013", "1", "0", "1", "0", "1", "0", "1", "Schlaganfall" };
        ...
        [TestMethod]
        public void InterpretElseAsRead()
        {
            Assert.AreEqual("Schlaganfall", FirstFindings(importer.Import(data2)).Else);
        }
